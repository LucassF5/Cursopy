...
# pip freeze ## Vai listar os pacotes que estão instalados

# requirements.txt vai ter todos os arquivos de venv baixados e/ou que vc usou no projeto
# Criando e usando um requirements.txt
# pip freeze > requirements.txt
# Instalando tudo do requirements.txt
# pip install -r requirements.txt ## Isso instala todos os arquivos do requirements
# -r significa requirements
# Para atualizar basta fazer o comando "pip freeze > requirements.txt" novamente
